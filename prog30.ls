...
/MN
 ...
 246:   ; ! Oddělovač.
 247:   ; ! Oddělovač.
 248:  !***************** ; ! Začátek nové části – mechanické čištění kartáčem (autorský návrh pro BP).
 249:  !Cisteni ; ! Titulek stanice čištění.
 250:  !***************** ; ! Titulek.
 251:   ; ! Oddělovač.
 252:  GO[3]=4 ; ! Oznamuje PLC obsluhu stanice čištění.
 253:   ; ! Oddělovač.
 254:  UFRAME_NUM=4 ; ! Přepíná na lokální rámec kartáče pro přesnou geometrii nové stanice.
 255:  UTOOL_NUM=5 ; ! Standardní griper drží trubku při čištění (UTOOL5).
 256:   ; ! Oddělovač.
 257:  !Korekce st.3 A ; ! Ruční korekce výšky kartáče – automatická kompenzace opotřebení je záměrně vypnutá.
 258:  WAIT R[19]>=(-2) AND R[19]<=2    ; ! Hlídá bezpečný rozsah výškové korekce R19, kartáč se jinak opotřebuje či zničí.
 259:  PR[26]=PR[21]    ; ! Základ dráhy čištění vychází z referenční pozice dílu.
 260:  PR[26,3]=PR[26,3]+R[19]    ; ! Přidává ruční přítlak kartáče v ose Z přes registr R19.
 261:   ; ! Oddělovač.
 262:J P[17] 100% CNT100    ; ! Přejezd k nájezdu stanice čištění.
 263:J P[19] 100% CNT100    ; ! Další bezpečný bod před trajektorií kartáče.
 264:   ; ! Oddělovač.
 265:   ; ! Oddělovač.
 266:  IF ((!DI[50] AND DI[49])),JMP LBL[41] ; ! Pokud není díl v chapadle, přeskočí se celá nová sekce čištění a odhrotování.
 267:   ; ! Oddělovač.
 268:J P[21] 100% CNT70 TB    .05sec,DO[113]=ON Tool_Offset,PR[21]    ; ! Najetí k náběhu kartáče v UF4/UT5, zapíná motor kartáče DO113.
 269:   ; ! Oddělovač.
 ...
 290:C P[49] Tool_Offset,PR[30]
    :  P[50] R[23]mm/sec CNT100 Tool_Offset,PR[27]    ; ! Dokončení obdélníku, stále s rychlostí R23 a kartáčem v záběru.
 291:   ; ! Oddělovač.
 292:L P[59] 2000mm/sec CNT50 Tool_Offset,PR[21]    ; ! Odjezd z kartáče s referencí na délku dílu.
 293:J P[60] 100% CNT100 Tool_Offset,PR[21]    ; ! Rychlý návrat k bezpečné pozici UF4/UT5, kartáč zůstává zapnutý pro následné odhrotování.
 294:   ; ! Oddělovač.
 295:   ; ! Oddělovač.
